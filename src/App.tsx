...
const INITIAL_PRODUCTS: Product[] = [
  {
    ...
    affiliate_url: "https://vendei.com.br/studio-master-500",
    upvotes: 128,
    category: "Tech"
  },
  {
    ...
    affiliate_url: "https://vendei.com.br/ultra-slim-mechanical",
    upvotes: 84,
    category: "Tools"
  },
  {
    ...
    affiliate_url: "https://vendei.com.br/canvas-pro-12",
    upvotes: 215,
    category: "Tech"
  },
  {
    ...
    affiliate_url: "https://vendei.com.br/nomad-watch-gen-3",
    upvotes: 56,
    category: "Curated"
  },
  {
    ...
    affiliate_url: "https://vendei.com.br/desk-light",
    upvotes: 42,
    category: "Home"
  },
  {
    ...
    affiliate_url: "https://vendei.com.br/leather-backpack",
    upvotes: 79,
    category: "Curated"
  },
];
...
export default function App() {
  ...
  const [products, setProducts] = useState<Product[]>(() => {
    const saved = localStorage.getItem('vendei_products');
    if (saved) {
  ...
  const [upvotedIds, setUpvotedIds] = useState<number[]>(() => {
    const saved = localStorage.getItem('vendei_upvoted');
  ...
  useEffect(() => {
    localStorage.setItem('vendei_products', JSON.stringify(products));
  }, [products]);

  useEffect(() => {
    localStorage.setItem('vendei_upvoted', JSON.stringify(upvotedIds));
  }, [upvotedIds]);
  ...
  // Handle submit form client override
  const handleSubmitProduct = (e: React.FormEvent) => {
    ...
    const affUrl = newAffiliateUrl.trim() || `https://vendei.com.br/product-${Date.now()}`;
  ...
  const handleResetCatalog = () => {
    ...
    setUpvotedIds([]);
    localStorage.removeItem('vendei_products');
    localStorage.removeItem('vendei_upvoted');
  };
  ...
  return (
    <div className="min-h-screen bg-neutral-50 flex flex-col font-sans select-none antialiased selection:bg-neutral-900 selection:text-white">
        ...
        <nav id="header-navbar" className="max-w-6xl mx-auto h-16 px-4 md:px-6 flex justify-between items-center">
          ...
          <div className="flex items-center gap-3">
            <button 
              ...
              className="bg-black text-white hover:bg-neutral-800 font-geist font-bold text-xs tracking-wider uppercase px-4 py-2.5 rounded transition-all duration-150 flex items-center gap-1.5 cursor-pointer shadow-sm active:scale-95"
            >
      ...
      <main className="max-w-6xl mx-auto px-4 md:px-6 flex-grow py-10 md:py-14 w-full">
        ...
        <section className="mb-10 text-left relative">
          <div className="flex justify-between items-start flex-col lg:flex-row lg:items-end gap-6">
            <div>
              ...
              <h1 className="font-geist text-4xl md:text-5xl font-black text-neutral-900 leading-none tracking-tight mb-3">
                Vendei<span className="text-black">.</span>
              </h1>
      ...
      {isDevGuideOpen && (
        <div className="fixed inset-0 z-50 bg-black/60 backdrop-blur-sm flex justify-end transition-opacity">
          <div className="bg-white w-full max-w-2xl h-full flex flex-col shadow-2xl relative animate-in slide-in-from-right duration-300">
            ...
            {/* Control Header */}
            <div className="border-b border-neutral-200 p-5 flex justify-between items-center bg-neutral-900 text-white">
              <div className="flex items-center gap-2">
                <Terminal className="w-5 h-5 text-amber-500" />
                <div>
                  <h3 className="font-geist font-black text-base">Vendei.com.br — Guia da Arquitetura</h3>
          ...
          <div className="bg-white border border-neutral-300 w-full max-w-lg rounded-xl overflow-hidden shadow-2xl relative animate-in zoom-in-95 duration-200">
            ...
            <form onSubmit={handleSubmitProduct} className="p-6 space-y-4">
              ...
              <div>
                ...
                <input 
                  type="url"
                  placeholder="https://vendei.com.br/seu-link-afiliado"
          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-8">
            ...
            <div className="flex flex-col gap-2">
              ...
              <p className="text-neutral-400 font-sans text-xs tracking-wide">
                © 2026 Vendei. High-Contrast Curated Products Core.
              </p>
            </div>
